                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.menus.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="menu_category_id" id="menu_category_id" class="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" data-nama="{{ strtolower($category->nama) }}">{{ $category->nama }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4" id="regular_price_container" style="display: none;">
                            ...
                            <input type="number" name="harga" id="harga" min="0" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4" id="size_prices_container" style="display: none;">
                            <div>
                                ...
                                <input type="number" name="harga_small" id="harga_small" min="0" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                @error('harga_small')
                                    <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="number" name="harga_medium" id="harga_medium" min="0" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                @error('harga_medium')
                                    <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="number" name="harga_large" id="harga_large" min="0" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                @error('harga_large')
                                    <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            <p class="text-xs text-gray-500 col-span-1 md:col-span-3 mt-1">Isi ukuran yang tersedia saja. Kosongkan jika tidak ada ukuran tersebut (Misal: Minuman hanya isi Harga Medium).</p>
                        </div>
                        ...
                        <div class="mb-4">
                            <label class="flex items-center">
                                <input type="checkbox" name="is_available" value="1" checked class="form-checkbox h-5 w-5 text-blue-600">
